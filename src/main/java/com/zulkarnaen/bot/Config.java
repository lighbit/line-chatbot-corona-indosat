package com.zulkarnaen.bot;

import com.linecorp.bot.client.LineMessagingClient;
import com.linecorp.bot.client.LineMessagingClientBuilder;
import com.linecorp.bot.client.LineSignatureValidator;
import com.zulkarnaen.bot.database.Dao;
import com.zulkarnaen.bot.database.DaoImpl;
...
public class Config {
	...
	public LineMessagingClient getMessagingClient() {
		return LineMessagingClient.builder(getChannelAccessToken())
				...
				.writeTimeout(LineMessagingClientBuilder.DEFAULT_WRITE_TIMEOUT).build();
	}
